...
import { faHome, faMusic, faRadio, faVideo, faPerson, faSignIn} from '@fortawesome/free-solid-svg-icons'
    ...
    return(
        ...
        {props.open == false ? <div className="mt-2 lg:mt-10 flex flex-col space-y-8 bg-darkalt lg:w-20 lg:rounded-full  lg:pb-4 lg:block hidde text-center w-11/12 mx-auto rounded-lg lg:relative absolut lg:ml-6 absolute ml-4 shadow-2xl shadow-black pb-40 z-50 ">
                ...
                <button className="mt- flex flex-row rounded-lg lg:mx-auto lg:w-8 hver:bg-yellow-500 ml-2 space-x-6">
                    <FontAwesomeIcon icon={faMusic} className="w-10 h-6 bg-white hover:bg-yellow-300"/>
                   <h1 className="lg:hidden text-white font-quicksand text-lg font-bold hover:text-yellow-500">
                    Music
                   </h1>
                </button>
                ...
                <button className="mt- flex flex-row  rounded-lg lg:mx-auto lg:w-9 justify-centr hver:bg-yellow-500 ml-2 space-x-6">
                    <FontAwesomeIcon icon={faRadio} className="w-10 h-6 bg-white hover:bg-yellow-300"/>
                ...
                <button className="mt- flex flex-row  rounded-lg lg:mx-auto lg:w-9 justify-cente ml-2 space-x-6">
                    <FontAwesomeIcon icon={faVideo} className="w-10 h-6 bg-white hover:bg-yellow-300"/>
                ...
                <button className="mt- flex flex-row  rounded-lg lg:mx-auto lg:w-10 justify-cente hovr:bg-yellow-500 ml-2 space-x-6">
                    <FontAwesomeIcon icon={faPerson} className="w-10 h-6 bg-white hover:bg-yellow-300"/>
     ...
     {/** Large screen views  */}
            ...
            <div className="hidden mt-2 lg:mt-10 flex flex-col space-y-8 bg-darkalt lg:w-20 lg:rounded-full  lg:pb-4 lg:block hidde text-center w-11/12 mx-auto rounded-lg lg:relative absolut lg:ml-6 absolute ml-4 shadow-2xl shadow-black pb-40 z-50 ">
                <button className="mt-4 flex flex-row  rounded-lg lg:mx-auto lg:w-8 hove:bg-yellow-500 ml-2 space-x-6">
                <FontAwesomeIcon  icon={faHome} className="w-10 h-6 bg-white hover:bg-yellow-300" onClick={props}/>
